...
import gd from "./data/groups";
import ed from "./data/entries";
...
const Desktop = () => {
  ...
  const [entryData, setEntryData] = useState(ed);
  const [groupData, setGroupData] = useState(gd);
